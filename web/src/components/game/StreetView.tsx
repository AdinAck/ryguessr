"use client"
import { GoogleMap, StreetViewPanorama, StreetViewPanoramaProps, useLoadScript } from "@react-google-maps/api";
...
const Streetview = memo(({ panoId }: { panoId?: string }) => {
  ...
  const { panningGesturesEnabled, streetNamesEnabled, zoomGesturesEnabled, userNavigationEnabled } = useStreetviewSettings();
  ...
  }, [panningGesturesEnabled, streetNamesEnabled, zoomGesturesEnabled, userNavigationEnabled, panoId])

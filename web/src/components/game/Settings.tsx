...
const Settings = () => {
  ...
  return (
    <div className="z-[99] w-md md:w-xl lg:w-2xl h-[50dvh] min-h-[400px] max-h-[800px] flex flex-row border-2 rounded-lg bg-background overflow-y-auto">
      ...
      <div className="flex flex-col grow-2 gap-3 py-2 px-4 bg-black rounded-lg w-full" id="settings_body">
